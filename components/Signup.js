        ...
        <section className="text-white body-font">
            <div className="container px-5 pb-24 mx-auto">
                ...
                <div className="relative flex-grow w-full">
                    <label htmlfFor="full-name" className="leading-7 text-sm text-gray-100">Full Name</label>
                ...
                <div className="relative flex-grow w-full">
                    <label htmlfFor="email" className="leading-7 text-sm text-gray-100">Email</label>
