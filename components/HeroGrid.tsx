            ...
            <div className="container px-5 mx-auto flex flex-wrap">
                ...
                <div className="flex flex-wrap w-1/2">
                    ...
                    <div className="md:p-2 p-1 w-1/2">
                        ...
                        <Image loader={imageLoader} alt="gallery-image" className="w-full object-cover h-full object-center block" src="./../../assets/images/cellos.jpeg" width={500} height={300} priority={true}/>
                        
                    </div>
                    <div className="md:p-2 p-1 w-full">
                        <Image loader={imageLoader} alt="gallery-image" className="w-full h-full object-cover object-center block" src="./../../assets/images/classical3.jpeg" width={850} height={400} priority={true} />
                    </div>
                </div>
                <div className="flex flex-wrap w-1/2">
                    <div className="md:p-2 p-1 w-full">
